        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-encore-dark text-white text-uppercase">
                    <h4 class="modal-title font-weight-bold" style="text-shadow: 1px 1px 2px black;">Register for Summer 2024 Now</h4>
...
{{--                        <img src="/images/fall-session.png" alt="fall session" class="img-fluid">--}}
                        <img src="/images/2024-summer-1.png" alt="summer session" class="img-fluid">
                    </a>
                </div>
