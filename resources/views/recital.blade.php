    ...
    <div class="container mt-3">
        <div class="row" style="height: 100%;">
            <div class="col-sm mt-3">
                <div>
                    <img src="/images/recital-23.png" alt="recital butterfly" class="img-fluid shadow rounded">
{{--                    <div class="d-flex justify-content-center">--}}
{{--                        <a href="https://play.google.com/store/apps/details?id=com.encoredancetheatre.mi" target="_blank"><img src="/images/edt-google-play.png" alt="apple mobile app" class="m-3 img-fluid"></a>--}}
{{--                        <a href="https://apps.apple.com/app/id1528239603" target="_blank"><img src="/images/edt-apple-store.png" alt="google mobile app" class="m-3 img-fluid"></a>--}}
{{--                    </div>--}}
                </div>
            </div>
            <div class="col-sm mt-3" class="d-flex align-items-center">
                <div>
...
{{--                    <span style="background: #0092BC;" class="text-white font-weight-bold rounded p-1 m-1">--}}
{{--                        Recitals are a wonderful way for students to showcase the results of their hard work and for family and friends to join in the pride of their achievement.--}}
{{--                    </span>--}}
{{--                    We love giving all students the chance to perform for their family and friends in a supportive environment and encourage even our youngest and newest performers to be involved.--}}
{{--                    <br><br>--}}
...
{{--                <br>--}}
{{--                *Dancers arrive 30 minutes before show time--}}
{{--            </div>--}}
{{--        </div>--}}
    </div>
