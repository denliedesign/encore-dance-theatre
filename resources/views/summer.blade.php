...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm">
                <img src="images/summer-company-intensive.jpg" alt="" class="img-fluid">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm">
                <img src="images/summer-mini-camps-1.jpg" alt="" class="img-fluid">
            </div>
            <div class="col-sm">
                <img src="images/summer-mini-camps-2.jpg" alt="" class="img-fluid">
            </div>
        </div>
