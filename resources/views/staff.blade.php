...
{{--                </div>--}}
                <div class="col-sm master-faculty-col">
                    <div class="row py-4">
                        <div class="col-sm-4 d-flex justify-content-sm-end justify-content-center">
                            <div class="headshot">
                                <img src="/images/staff-alana.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="accordion faculty-bio" id="accordionExample">
                                <div class="card">
                                    <div class="card-header faculty-card-header" id="headingOne">
                                        <h2 class="mb-0 d-flex justify-content-center">
                                            <button class="btn btn-link" style="height: 84px;" type="button" data-toggle="collapse" data-target="#collapseAlana" aria-expanded="true" aria-controls="collapseOne">
                                                Alana Scheuerer
                                            </button>
                                        </h2>
                                    </div>

                                    <div id="collapseAlana" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                        <div class="card-body faculty-bio-txt">
